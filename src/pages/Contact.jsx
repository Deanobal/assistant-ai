        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="mt-5 text-gray-400 text-lg max-w-2xl mx-auto">
              Tell us about your business and we'll show you exactly how AI can help you capture more leads, answer every call, and grow.
            </p>
          </motion.div>
            ...
            >
              <div className="p-6 rounded-2xl border border-white/5 bg-[#12121a]">
                ...
                <ol className="space-y-4">
                  {[
                    ...
                    'A team member contacts you to schedule a call',
                    'We discuss your business goals and challenges',
                    'You receive a custom AI strategy recommendation',
                  ].map((step, i) => (
              ...
              <div className="p-6 rounded-2xl border border-cyan-500/20 bg-gradient-to-b from-cyan-500/5 to-transparent">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  This is a genuine strategy call to explore how AI can help your specific business. If it's a good fit, great. If not, you'll still walk away with actionable insights.
                </p>
              </div>
            </motion.div>
          </div>
