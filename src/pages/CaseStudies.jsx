    ...
    <div>
      <section className="relative py-24 md:py-32 bg-grid">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <p className="text-cyan-400 text-sm font-medium mb-3">USE CASES</p>
                    ...
                    <div className="grid lg:grid-cols-5 gap-8">
                      <div className="lg:col-span-3 p-8 md:p-10">
                        <div className="flex items-center gap-3 mb-6">
                          ...
                          <div>
                            <p className="text-cyan-400 text-xs font-medium uppercase tracking-[0.2em] mb-1">{study.company}</p>
