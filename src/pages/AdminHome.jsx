  ...
  return (
    <div className="space-y-8">
      <div className="rounded-[28px] border border-cyan-400/20 bg-gradient-to-br from-cyan-500/10 to-blue-500/5 p-8">
        ...
        <p className="mt-4 max-w-3xl text-slate-300">Manage leads, clients, onboarding, offers, navigation, FAQs, social proof, content, media, landing pages, blog posts, SEO, campaigns and launch readiness from one internal workspace.</p>
      </div>
