      ...
      <div className="relative mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-12 md:px-8 md:py-16 lg:min-h-[calc(100vh-5.5rem)] lg:flex lg:items-center">
        <div className="grid w-full items-center gap-8 sm:gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(360px,0.9fr)] lg:gap-14">
          <div className="mx-auto max-w-2xl text-center lg:mx-0 lg:text-left">
            <div className="mb-4 inline-flex max-w-full items-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-400/5 px-3 py-1.5">
              <div className="h-1.5 w-1.5 shrink-0 rounded-full bg-cyan-400" />
              <span className="truncate text-xs font-medium text-cyan-300 sm:text-sm">AI Receptionist + Sales Automation for Australian Businesses</span>
            </div>

            <h1 className="mx-auto max-w-3xl text-4xl font-bold leading-[1.02] tracking-[-0.04em] text-white xs:text-[2.65rem] sm:text-5xl md:text-6xl lg:mx-0 lg:text-[4.35rem] lg:leading-[0.98] xl:text-[4.7rem]">
            ...
            <div className="mx-auto mt-6 flex max-w-xl flex-wrap justify-center gap-2 text-xs text-slate-300 sm:text-sm lg:mx-0 lg:justify-start">
          ...
          <div className="mx-auto flex w-full max-w-[420px] justify-center lg:max-w-none lg:justify-end">
            <HeroBrainCard />
          </div>
        </div>
      </div>
