...
import { Database, CalendarDays, MessageSquare, BarChart3 } from 'lucide-react';
    ...
    <section className="relative py-16 md:py-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-10 text-center">
          <Link to="/Integrations" className="text-cyan-400 text-base font-medium inline-flex items-center gap-2 hover:text-cyan-300 transition-colors">
