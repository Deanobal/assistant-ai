...
...
        ...
        <div className="mt-10 text-center">
          <Link
            to="/Integrations" className="text-cyan-400 text-base font-medium inline-flex items-center gap-2 hover:text-cyan-300 transition-colors">Explore Integrations
