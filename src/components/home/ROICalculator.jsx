          ...
          <div className="grid divide-y divide-white/8 md:grid-cols-2 md:divide-x md:divide-y-0">
            <div className="p-8 md:p-10">
              ...
              <div className="space-y-8">
                ...
                <p className="rounded-xl border border-white/5 bg-white/[0.02] p-4 text-xs leading-6 text-slate-500">
                  Adjust the values above to see the potential revenue captured when more missed calls are answered and qualified by your AI receptionist.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col p-8 md:p-10">
              ...
              <div className="grid flex-1 gap-3 sm:grid-cols-2">
                {resultCards.map((card) => (
                  <div key={card.label} className="rounded-2xl border border-white/8 bg-white/[0.03] p-5">
                    <p className="mb-2 text-xs text-slate-500">{card.label}</p>
              ...
              <div className="mt-5 rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-600 p-5">
                <p className="text-sm text-white/70">Revenue you could be capturing</p>
                ...
                <p className="mt-1 text-xs text-white/60">${yearlyRevenue.toLocaleString()} per year</p>
              </div>

              <Link
                to="/BookStrategyCall"
                className="mt-5 inline-flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-white/[0.08]"
              >
