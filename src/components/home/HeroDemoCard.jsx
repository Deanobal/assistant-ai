      ...
      <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-[#0b0f18]/90 p-5 shadow-[0_24px_90px_rgba(6,182,212,0.14)] backdrop-blur-xl sm:p-6">
        ...
        <div className="mt-5 rounded-[24px] border border-white/8 bg-[linear-gradient(180deg,rgba(17,24,39,0.98),rgba(8,12,20,0.96))] p-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-xs uppercase tracking-[0.24em] text-cyan-300/80">Try the receptionist now</p>
              <h3 className="mt-2 text-xl font-semibold text-white">Talk to the AI receptionist</h3>
          ...
          <div className="mt-5 rounded-2xl border border-white/8 bg-black/20 p-4 sm:p-5">
            ...
            <div className="overflow-hidden rounded-[22px] border border-white/10 bg-[#060910] px-3 py-4 sm:px-4">
              <div className="flex min-h-[320px] items-center justify-center sm:min-h-[360px] [&_elevenlabs-convai]:w-full [&_elevenlabs-convai]:max-w-none">
