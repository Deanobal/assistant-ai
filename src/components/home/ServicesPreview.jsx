  ...
  return (
    <section className="relative py-16 md:py-20 bg-[#0c0c14]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <p className="text-cyan-400 text-lg font-medium mb-3">SERVICES</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((s, i) => (
            <motion.div
              ...
              className="p-6 rounded-2xl border border-white/5 bg-[#12121a] card-hover group"
            >
        ...
        <div className="mt-10 text-center">
          <Link
            to="/Services"
            className="inline-flex items-center gap-2 text-cyan-400 text-base font-medium hover:text-cyan-300 transition-colors"
          >
