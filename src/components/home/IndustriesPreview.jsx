...
import { Wrench, Home, Heart, Scale } from 'lucide-react';
    ...
    <section className="relative py-16 md:py-20 bg-[#0c0c14]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-10 text-center">
          <Link to="/Industries" className="text-cyan-400 text-base font-medium inline-flex items-center gap-2 hover:text-cyan-300 transition-colors">
