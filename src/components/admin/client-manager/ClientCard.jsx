...
export default function ClientCard({ client, onboarding }) {
  const industryLabel = client.industry ? client.industry.replace('_', ' ') : 'Not set';
  const monthlyRevenue = typeof client.monthly_revenue === 'number' ? client.monthly_revenue : 0;
      ...
      <CardContent className="p-6 space-y-5">
        ...
        <div className="grid sm:grid-cols-2 gap-3 text-sm">
          <div className="rounded-2xl border border-white/5 bg-white/[0.03] px-4 py-3">
            ...
            <p className="text-white mt-1">{industryLabel}</p>
          </div>
          <div className="rounded-2xl border border-white/5 bg-white/[0.03] px-4 py-3">
          ...
          <div className="rounded-2xl border border-white/5 bg-white/[0.03] px-4 py-3">
            ...
            <p className="text-white mt-1">${monthlyRevenue.toLocaleString()}</p>
          </div>
          <div className="rounded-2xl border border-white/5 bg-white/[0.03] px-4 py-3">
