...
import { BarChart3, ClipboardList, DollarSign, FileText, HelpCircle, Image, Layers, Mail, MessageSquareQuote, Navigation, PencilRuler, Settings, SlidersHorizontal, Sparkles, Menu, X } from 'lucide-react';
...
export default function MarketingLayout() {
  ...
  const navItems = [
    ...
    { label: 'Pricing Manager', path: '/admin/marketing/pricing', icon: DollarSign },
    { label: 'Social Proof', path: '/admin/marketing/social-proof', icon: MessageSquareQuote },
    { label: 'FAQ Manager', path: '/admin/marketing/faqs', icon: HelpCircle },
    { label: 'Navigation', path: '/admin/marketing/navigation', icon: Navigation },
    { label: 'Form Builder', path: '/admin/marketing/forms', icon: ClipboardList },
      ...
      >
        <div className="flex flex-col h-full p-6">
          <div className="mb-8">
            ...
            <p className="text-xs text-slate-500 mt-1">SEO, AI, Offers, Proof & Campaigns</p>
          </div>
      ...
      <main className="lg:ml-64 min-h-screen">
        <div className="border-b border-white/10 bg-[#070a12]/50 backdrop-blur-sm sticky top-0 z-30">
          <div className="px-6 py-4 lg:px-8">
            ...
            <p className="text-sm text-slate-400 mt-1">Manage AI content, offers, forms, FAQs, social proof, SEO, navigation, landing pages, blog, website copy, media and campaigns</p>
          </div>
        </div>
