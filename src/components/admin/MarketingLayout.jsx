...
import { BarChart3, DollarSign, FileText, HelpCircle, Image, Layers, Mail, MessageSquareQuote, PencilRuler, Settings, SlidersHorizontal, Sparkles, Menu, X } from 'lucide-react';
      ...
      <main className="lg:ml-64 min-h-screen">
        <div className="border-b border-white/10 bg-[#070a12]/50 backdrop-blur-sm sticky top-0 z-30">
          <div className="px-6 py-4 lg:px-8">
            ...
            <p className="text-sm text-slate-400 mt-1">Manage AI content, offers, FAQs, social proof, SEO, landing pages, blog, website copy, media and campaigns</p>
          </div>
        </div>
