export const blogPosts = [
  {
    slug: 'dont-miss-74-of-calls',
    title: 'Don’t Miss 74% of Calls: Why Every Service Business Needs an AI Receptionist',
  ...
  {
    slug: 'virtual-ai-receptionist-benefits',
    title: '24/7 Coverage Without the Cost: The Benefits of Virtual AI Receptionists',
  ...
  },
  {
    ...
    title: 'Stop Losing Leads After Hours: How AI Receptionists Keep Lines Open',
  ...
  {
    slug: 'reduce-operational-costs-ai-automation',
    title: 'Reduce Operational Costs by 20–30% with AI Process Automation',
    ...
    body: [
      ...
      'By automating your back‑office workflows—such as updating your CRM, sending follow‑up emails or generating quotes—you free up staff time to focus on higher‑value work. Automation also scales easily as your business grows, ensuring you can handle more customers without adding headcount.'
    ]
  },
  {
    slug: 'ai-adoption-boosts-profitability',
    title: 'AI Adoption Boosts Profitability for Australian SMBs',
    ...
    body: [
      ...
      'For trades and service businesses struggling with rising labour costs and skill shortages, adopting AI isn’t optional—it’s key to remaining competitive.'
    ]
  },
  {
    slug: 'maximise-rd-tax-incentive',
    title: 'Maximise Your R&D Tax Incentive for AI Projects',
    ...
    body: [
      ...
      'If you’re investing in AI automation, make sure you keep detailed records of your development work and consult with an R&D tax advisor to maximise your rebate. The incentive can significantly offset development costs and improve the ROI of your AI project.'
    ]
  },
  {
    slug: 'what-is-an-ai-receptionist',
    title: 'What Is an AI Receptionist? Understanding AI Automation for Service Businesses',
    ...
    body: [
      ...
      'AI receptionists learn from interactions over time, so they continually improve and can handle industry‑specific questions—whether you’re a plumber, electrician or cleaning service.'
    ]
  },
  {
  ...
  },
  {
    ...
    title: 'AI Scheduling: Automate Appointments and Reduce No‑Shows',
    ...
    body: [
      ...
      'AI scheduling systems connect directly to your calendar, offer available times to customers via phone or chat, send reminders and automatically handle rescheduling. This reduces no‑shows, improves customer satisfaction and frees your team to focus on delivering services.'
    ]
  },
  {
    slug: 'ai-powered-lead-capture',
    title: 'Never Forget a Follow‑Up: AI‑Powered Lead Capture',
